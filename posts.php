...
register_post_type(fw()->extensions->get('slider')->get_post_type(), array(
	'labels' => array(
		...
		'all_items' => __('Sliders22', 'fw'),
		'view_item' => __('View Slider', 'fw'),
		'search_items' => __('Search Sliders22', 'fw'),
		'not_found' => __('No Sliders22 found', 'fw'),
		'not_found_in_trash' => __('No Sliders22 found in Trash', 'fw'),
		'parent_item_colon' => '',
		'menu_name' => __('Sliders22', 'fw')
	),
	'public' => false,
	 ...
	 * else, the Sliders22 menu will appear, but when clicked on it
